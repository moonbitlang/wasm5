...
static uint32_t wasi_path_open(uint64_t* args, uint8_t* mem, int mem_size) {
...
static uint32_t wasi_path_filestat_get(uint64_t* args, uint8_t* mem, int mem_size) {
    uint32_t dirfd = (uint32_t)args[0];
...
static uint32_t wasi_path_create_directory(uint64_t* args, uint8_t* mem, int mem_size) {
    uint32_t dirfd = (uint32_t)args[0];
...
static uint32_t wasi_path_remove_directory(uint64_t* args, uint8_t* mem, int mem_size) {
    uint32_t dirfd = (uint32_t)args[0];
    uint32_t path_ptr = (uint32_t)args[1];
    uint32_t path_len = (uint32_t)args[2];
...
static uint32_t wasi_path_unlink_file(uint64_t* args, uint8_t* mem, int mem_size) {
    uint32_t dirfd = (uint32_t)args[0];
    uint32_t path_ptr = (uint32_t)args[1];
    uint32_t path_len = (uint32_t)args[2];
...
static uint32_t wasi_path_rename(uint64_t* args, uint8_t* mem, int mem_size) {
...
static uint32_t wasi_fd_pread(uint64_t* args, uint8_t* mem, int mem_size) {
    uint32_t fd = (uint32_t)args[0];
...
static uint32_t wasi_fd_pwrite(uint64_t* args, uint8_t* mem, int mem_size) {
    uint32_t fd = (uint32_t)args[0];
    uint32_t iovs_ptr = (uint32_t)args[1];
    uint32_t iovs_len = (uint32_t)args[2];
    uint64_t offset = args[3];
...
static uint32_t wasi_fd_fdstat_set_flags(uint64_t* args) {
    uint32_t fd = (uint32_t)args[0];
...
static uint32_t wasi_fd_filestat_set_size(uint64_t* args) {
    uint32_t fd = (uint32_t)args[0];
...
static uint32_t wasi_fd_filestat_set_times(uint64_t* args) {
    uint32_t fd = (uint32_t)args[0];
...
static uint32_t wasi_fd_advise(uint64_t* args) {
    uint32_t fd = (uint32_t)args[0];
...
static uint32_t wasi_fd_allocate(uint64_t* args) {
    uint32_t fd = (uint32_t)args[0];
    uint64_t offset = args[1];
    uint64_t len = args[2];
...
static uint32_t wasi_clock_res_get(uint64_t* args, uint8_t* mem, int mem_size) {
    uint32_t clock_id = (uint32_t)args[0];
...
static uint32_t wasi_proc_raise(uint64_t* args) {
...
static uint32_t wasi_fd_readdir(uint64_t* args, uint8_t* mem, int mem_size) {
    uint32_t fd = (uint32_t)args[0];
    uint32_t buf_ptr = (uint32_t)args[1];
