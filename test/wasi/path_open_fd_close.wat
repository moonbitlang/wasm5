;; Test path_open + fd_close using preopened dir (fd 4)
(module
  ...
  (func (export "_start")
    ...
    ;; path_open(dirfd=4, path="file.txt")
    (local.set $err (call $path_open
      ...
      (i64.const 70) ;; rights_base = FD_READ|FD_WRITE|FD_SEEK
    ...
    (local.set $err (call $fd_close (local.get $fd)))
